...
int main(int argc, char **argv)
{
 ...
 / Búsqueda dicotómica para encontrar el mejor tamaño de chunk
    int min_cs = 1; // Tamaño mínimo de chunk
    int max_cs = Rows / NThreads; // Tamaño máximo de chunk
    double T_min_cs, T_max_cs, T_med_cs; // Tiempos de ejecución

    // Variables para almacenar el mejor chunk
    int best_chunk_size = ChunckSize; // Inicializar con el tamaño de chunk actual
    double best_time = 1e9; // Inicializar el mejor tiempo a un valor alto
